            ...
            return (
              ...
              >
                <div className="cell-header">
                  ...
                  {count > 0 && <span className="cell-event-badge">{count}</span>}
                </div>
      ...
      {selectedDateStr && (
        <div className="month-details-drawer slide-in-right">
          <div className="drawer-header">
            ...
            <button className="drawer-close-btn" onClick={() => setSelectedDateStr(null)}>✕</button>
          </div>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="card-metadata">
                        <span className="meta-tag tag-class">👥 {seance.classe.nom}</span>
                        <span className="meta-tag tag-room">🏫 {room}</span>
                      </div>
